...
const Footer = () => {
  const socialLinks = [
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/zuccess.inc?igsh=aDZ2YTM1Nnc3bW5s',
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-[#0A0A5B]">
...
<img src="/zuccess logo without bg-34.png" alt="ZUCCESS" className="h-30 w-40" />
              <div>
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex flex-col items-center space-y-2 mt-4">
              ...
              <div className="flex items-center space-x-2 text-white/80 hover:text-white transition-colors duration-200">
                <Mail size={16} />
                <a href="mailto:info@zuccess.net" className="hover:underline text-sm">
                  info@zuccess.net
                </a>
              </div>
              <div className="flex items-center space-x-2 text-white/80 hover:text-white transition-colors duration-200">
                <Phone size={16} />
                <a href="tel:+971503294644" className="hover:underline text-sm">
                  +971-503294644
                </a>
              </div>
            </div>
